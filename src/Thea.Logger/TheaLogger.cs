...
public class TheaLogger : ILogger
{
    ...
    public TheaLogger(string name, IConfiguration configuration, TheaLoggerProcessor processor)
    {
    ...
    public void Log<TState>(LogLevel logLevel, EventId eventId, TState state, Exception exception, Func<TState, Exception, string> formatter)
    {
        ...
        if (string.IsNullOrEmpty(logEntityInfo.LogTime))
            logEntityInfo.LogTime = logEntityInfo.CreatedAt.ToString("yyyy-MM-dd HH:mm:ss.fff");
        ...
        this.processor.TryPush(logEntityInfo);
    }
