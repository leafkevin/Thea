...
public class GrTagHelper : TagHelper
{
    ...
    public override async Task ProcessAsync(TagHelperContext context, TagHelperOutput output)
    {
        ...
        var tagValue = await this.globalizationGlossary.GetGlossaryAsync(this.Tag, this.Culture);
    ...
    {
        output.TagName = string.Empty;
        var tagValue = this.globalizationGlossary.GetGlossary(this.Tag, this.Culture);
        output.Content.SetHtmlContent(tagValue);
        output.TagMode = TagMode.SelfClosing;
    }
}
