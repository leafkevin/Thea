...
(
    ...
    `IsUseRpc` TINYINT(1) NOT NULL DEFAULT 1 COMMENT '是否启用RPC模式',
    `IsUseDelay` TINYINT(1) NOT NULL DEFAULT 1 COMMENT '是否启用延时消息',
    `IsLogEnabled` TINYINT(1) NOT NULL DEFAULT 1 COMMENT '是否启用日志',
