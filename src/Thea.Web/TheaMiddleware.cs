...
public class TheaMiddleware
{
    private readonly RequestDelegate next;
    private readonly ILogger<TheaMiddleware> logger;

    public TheaMiddleware(RequestDelegate next, ILogger<TheaMiddleware> logger)
    {
        this.next = next;
        this.logger = logger;
    }
    ...
    public async Task Invoke(HttpContext context)
    {
        ...
        using (this.logger.BeginScope(logScope))
        {
            ...
            try
            {
                ...
                UpdateLogEntityInfo(context, respBody, logEntityInfo);
    ...
    private void UpdateLogEntityInfo(HttpContext context, string respBody, LogEntity logEntityInfo)
    {
        ...
        logEntityInfo.Body = $"Request finished. State:{logEntityInfo.StatusCode},Elapsed: {logEntityInfo.Elapsed + "ms"}";
    }
    ...
    private async Task ProcessException(HttpContext context, Exception ex, LogEntity logEntityInfo)
    {
        ...
        logEntityInfo.Body =
            $"Request error. State:{logEntityInfo.StatusCode},Elapsed: {logEntityInfo.Elapsed + "ms"},Detail:{Environment.NewLine}{ex.Message}";
